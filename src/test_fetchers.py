...
from src.fetch.pokemon_fetcher import PokemonFetcher
from src.fetch.item_fetcher import ItemFetcher
from src.fetch.type_relations_fetcher import TypeRelationsFetcher
